  ...
  <header id="header" class="app-header navbar" role="menu">
      ...
      <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
        ...
        <div class="nav navbar-nav hidden-xs">
          <img src="img/corporate-logo.png" class="brand-logo"/>
        </div>

        <div class="nav navbar-nav hidden-xs" style="text-align: center !important;padding-left: 407px;"><center>
          <h2>Customer Connect</h2></center>
        </div>
        <!--
        <div class="nav navbar-nav hidden-xs">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              ...
              <span class="hidden-sm hidden-md">Ranjeet Jain</span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
